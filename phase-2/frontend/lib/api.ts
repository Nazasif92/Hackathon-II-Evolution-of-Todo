...
class ApiClient {
   ...
   * The JWT plugin exposes /api/auth/token endpoint
   */
  private async getAuthToken(): Promise<string | null> {
    try {
      // Better Auth JWT plugin exposes tokens via /api/auth/token endpoint
      // Must include credentials for session cookie
