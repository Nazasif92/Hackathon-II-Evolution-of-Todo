...
You MUST delegate tasks to specialized agents based on the domain. Use the Task tool to invoke the appropriate agent.
...
### Database Agent (`neon-database-architect`)
**Use for:** All database design and operations
- Schema design for users and todos tables
- Neon Serverless PostgreSQL configuration
- SQL query optimization
- Database migrations
- Connection pooling setup
- Foreign key relationships (user_id → todos)
...
```
# Authentication task
Task(subagent_type="auth-security", prompt="Implement user signup with Better Auth...")

# Frontend task
Task(subagent_type="frontend-nextjs", prompt="Create todo list page with App Router...")

# Backend task
Task(subagent_type="fastapi-backend", prompt="Create CRUD endpoints for todos...")

# Database task
Task(subagent_type="neon-database-architect", prompt="Design schema for users and todos...")
```
...
```
DATABASE_URL=<neon_connection_string>
JWT_SECRET=<shared_secret_with_better_auth>
